...
> [!NOTE]
> In May 2026 and in version 0.14.0, this project was merged with its predecessor, the
> [ADD Metadata Toolbox 🛡️](https://gitlab.data.bas.ac.uk/MAGIC/add-metadata-toolbox/) by pre-pending commits,
> change log entries and releases.
>
> Existing Lantern releases (from 0.1.0 to 0.6.1) have been re-allocated starting from 0.8.0, in this change log, git
> tags and Python packages.
...
* Prepending ADD Metadata Toolbox change log entries and releases, advancing Lantern releases accordingly
...
* 'upgrade-records' development task for upgrading records to new MAGIC profiles and other bulk improvements
* list of supported distribution option types in documentation
...
* Infrastructure documentation
  [#400](https://gitlab.data.bas.ac.uk/MAGIC/add-metadata-toolbox/-/issues/400)
...
* Building CI container automatically in CI
  [#397](https://gitlab.data.bas.ac.uk/MAGIC/add-metadata-toolbox/-/issues/397)
...
* Initial version as per [MAGIC/add#141](https://gitlab.data.bas.ac.uk/MAGIC/add/issues/141)
