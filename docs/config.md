...
|--------------------------------------------|--------------|--------------|----------|-----------|-----------------|------------------------------------------------------------------------------------|-------------------------------------------|-------------------------------------------------|
| `ADMIN_METADATA_ENCRYPTION_KEY_PRIVATE`    | JSON Web Key | Yes          | Yes      | Yes       | v0.4.x (0.11.x) | JSON Web Key (JWK) for accessing administrative metadata                           | *None*                                    | '{"kid": "magic_metadata_encryption_key", ...}' |
...
| `CHECKS_MAGIC_PRODUCTS_CLIENT_ID`          | String       | Yes          | Yes      | No        | v0.15.x         | Client ID for an Entra app that can access the MAGIC Products Distribution Service | *None*                                    | 'e213df49-c964-471d-ad2f-5166191b9727'          |
| `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET`      | String       | Yes          | Yes      | Yes       | v0.15.x         | Client secret for Entra app identified by `CHECKS_MAGIC_PRODUCTS_CLIENT_ID`        | *None*                                    | 'xxx'                                           |
| `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET_EXP`  | Date         | Yes          | Yes      | No        | v0.15.x         | Expiry for `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET`                                   | *None*                                    | '2014-06-30'                                    |
| `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET_ID`   | String       | Yes          | Yes      | No        | v0.15.x         | Non-sensitive ID for `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET`                         | *None*                                    | '68f6cb72-4ece-4e0f-8a6a-ff8d29000593'          |
| `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET_SAFE` | String       | No           | -        | No        | v0.15.x         | Redacted version of `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET`                          | *None*                                    | 'REDACTED'                                      |
| `CHECKS_MAGIC_PRODUCTS_TENANT_ID`          | String       | Yes          | Yes      | No        | v0.15.x         | Entra tenant for `CHECKS_MAGIC_PRODUCTS_CLIENT_ID`                                 | *None*                                    | '38b42623-c0d0-4640-b8dc-0c818eeb8cf6'          |
...
| `PARALLEL_JOBS`                            | Number       | Yes          | No       | No        | v0.3.x (0.10.x) | Number of parallel jobs to run for applicable tasks                                | 1                                         | '4'                                             |
| `SENTRY_DSN`                               | String       | No           | -        | No        | v0.1.x (0.8.0)  | Sentry connection string for backend error monitoring (not sensitive)              | *N/A*                                     | 'https://example.com'                           |
| `SENTRY_ENVIRONMENT`                       | String       | Yes          | No       | No        | v0.1.x (0.8.x)  | Application runtime environment to include in Sentry errors                        | 'development'                             | 'production'                                    |
| `SITE_TRUSTED_RSYNC_BASE_PATH_LIVE`        | String       | Yes          | Yes      | No        | v0.6.x (0.13.x) | Path for trusted site content within upload server (live environment)              | *None*                                    | '/data/content/live'                            |
| `SITE_TRUSTED_RSYNC_BASE_PATH_TESTING`     | String       | Yes          | Yes      | No        | v0.6.x (0.13.x) | Path for trusted site content within upload server (testing environment)           | *None*                                    | '/data/content/testing'                         |
| `SITE_TRUSTED_RSYNC_HOST`                  | String       | Yes          | Yes      | No        | v0.6.x (0.13.x) | SSH config alias for trusted site uploads                                          | *None*                                    | "lantern-trusted-content"                       |
...
| `SITE_UNTRUSTED_S3_BUCKET_LIVE`            | String       | Yes          | Yes      | No        | v0.6.x (0.13.x) | AWS S3 bucket used for untrusted site (live environment)                           | *None*                                    | 'example.com'                                   |
| `SITE_UNTRUSTED_S3_BUCKET_TESTING`         | String       | Yes          | Yes      | No        | v0.6.x (0.13.x) | AWS S3 bucket used for untrusted site (testing environment)                        | *None*                                    | 'testing.example.com'                           |
| `STORE_ALGOLIA_APP_ID`                     | String       | Yes          | Yes      | No        | v0.15.x         | Algolia application identifier                                                     | *None                                     | 'ABCDE12345'                                    |
| `STORE_ALGOLIA_INDEX_NAME`                 | String       | No           | -        | No        | v0.15.x         | Algolia index name                                                                 | *None                                     | 'items-all-v1'                                  |
| `STORE_ALGOLIA_WRITE_API_KEY`              | String       | Yes          | Yes      | Yes       | v0.15.x         | Algolia write API key for managing search indices in the backend                   | *None                                     | 'xxx'                                           |
| `STORE_ALGOLIA_WRITE_API_KEY_SAFE`         | String       | No           | Yes      | No        | v0.15.x         | Redacted version of `STORE_ALGOLIA_WRITE_API_KEY`                                  | *N/A*                                     | ''REDACTED'                                     |
| `STORE_GITLAB_CACHE_PATH`                  | Path         | Yes          | Yes      | No        | v0.1.x (0.8.x)  | Location for GitLab store's local records cache                                    | *None*                                    | '/tmp/gitlab_cache/'                            |
| `STORE_GITLAB_DEFAULT_BRANCH`              | String       | Yes          | Yes      | No        | v0.6.x (0.13.x) | GitLab store's default remote branch name                                          | *None*                                    | 'main'                                          |
| `STORE_GITLAB_ENDPOINT`                    | String       | Yes          | Yes      | No        | v0.1.x (0.8.x)  | Base API endpoint for GitLab store's remote instance                               | *None*                                    | 'https://gitlab.com'                            |
| `STORE_GITLAB_PROJECT_ID`                  | String       | Yes          | Yes      | No        | v0.1.x (0.8.x)  | GitLab project ID for GitLab store's remote instance                               | *None*                                    | '123'                                           |
| `STORE_GITLAB_TOKEN`                       | String       | Yes          | Yes      | Yes       | v0.1.x (0.8.x)  | API access token for GitLab store's remote instance                                | *None*                                    | 'glpat-xxx'                                     |
| `STORE_GITLAB_TOKEN_SAFE`                  | String       | No           | -        | No        | v0.1.x (0.8.x)  | Redacted version of `STORE_GITLAB_TOKEN`                                           | *N/A*                                     | 'REDACTED'                                      |
| `TEMPLATES_ALGOLIA_APP_ID`                 | String       | Yes          | Yes      | No        | v0.15.x         | Algolia application identifier                                                     | *N/A*                                     | 'ABCDE12345'                                    |
| `TEMPLATES_ALGOLIA_INDEX_NAME`             | String       | No           | Yes      | No        | v0.15.x         | Algolia index name (value locked to `STORE_ALGOLIA_INDEX_NAME`)                    | *N/A*                                     | 'items-all-v1'                                  |
| `TEMPLATES_ALGOLIA_SEARCH_API_KEY`         | String       | Yes          | Yes      | No        | v0.15.x         | Algolia search API key for querying search indices in the frontend                 | *None                                     | 'xxx'                                           |
| `TEMPLATES_CACHE_BUST_VALUE`               | String       | No           | -        | No        | v0.1.x (0.8.x)  | Query string value appended to site assets to avoid stale browser caches           | *N/A*                                     | '0.3.0'                                         |
| `TEMPLATES_ITEM_CONTACT_ENDPOINT`          | String       | Yes          | Yes      | No        | v0.1.x (0.8.x)  | Microsoft Power Automate trigger endpoint for item contact form                    | *N/A*                                     | 'https://example.com'                           |
| `TEMPLATES_ITEM_MAPS_ENDPOINT`             | String       | Yes          | No       | No        | v0.1.x (0.8.x)  | Embedded Maps Service base endpoint                                                | `https://embedded-maps.data.bas.ac.uk/v1` | 'https://embedded-maps.data.bas.ac.uk/v1'       |
| `TEMPLATES_ITEM_VERSIONS_ENDPOINT`         | String       | Yes          | Yes      | No        | v0.2.x (0.9.x)  | Base URL to a GitLab project for viewing item record revisions                     | *None*                                    | 'https://example.com'                           |
| `TEMPLATES_PLAUSIBLE_ID`                   | String       | No           | -        | No        | v0.5.x (0.12.x) | Plausible site identifier for frontend analytics                                   | *None*                                    | 'pa-xxx'                                        |
| `TEMPLATES_TURNSTILE_KEY`                  | String       | Yes          | Yes      | No        | v0.15.x         | Cloudflare Turnstile site key for item contact form                                | *N/A*                                     | 'x'                                             |
| `VERSION`                                  | String       | No           | -        | No        | v0.1.x (0.8.x)  | Application package version                                                        | *N/A*                                     | '0.3.0'                                         |
<!-- pyml enable md013 -->
...
- `CHECKS_MAGIC_PRODUCTS_CLIENT_ID`
- `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET`
- `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET_EXP`
- `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET_ID`
- `CHECKS_MAGIC_PRODUCTS_CLIENT_SECRET_SAFE`
- `CHECKS_MAGIC_PRODUCTS_TENANT_ID`
...
- `STORE_ALGOLIA_APP_ID`
- `STORE_ALGOLIA_INDEX_NAME`
- `STORE_ALGOLIA_WRITE_API_KEY`
- `STORE_ALGOLIA_WRITE_API_KEY_SAFE`
...
- `TEMPLATES_ALGOLIA_APP_ID`
- `TEMPLATES_ALGOLIA_INDEX_NAME`
- `TEMPLATES_ALGOLIA_SEARCH_API_KEY`
