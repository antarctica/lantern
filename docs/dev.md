...
To run the [Publishing Workflows](/docs/usage.md) locally:

1. create a new AWS IAM user (e.g. `conwat-lantern`) with a suitable
   ...
   to manage content in [AWS S3 publishing buckets](/docs/infrastructure.md#exporters)
