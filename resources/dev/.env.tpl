...
X_DEPOSIT_TENANT_ID="op://Infrastructure/e7rftaanttrgjfyoppl3rqqlcm/tenancy-id"
X_DEPOSIT_CLIENT_ID="op://Infrastructure/e7rftaanttrgjfyoppl3rqqlcm/username"
X_DEPOSIT_CLIENT_SECRET=""  # populate with per-user/instance client secret
