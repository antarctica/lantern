...
class CatalogueServiceWeb(object):
    ...
    def getrecords(
        ...
        if self.exceptionreport is None:
            ...
            val = self._exml.find(util.nspath_eval("csw:SearchResults", namespaces)).attrib.get(
    ...
    def _setconstraint(
        self, parent, qtype=None, propertyname="csw:AnyText", keywords=[], bbox=None, cql=None, identifier=None
    ):
