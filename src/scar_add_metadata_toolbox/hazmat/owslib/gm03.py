...
class HeaderSection(object):
    ...
    def __init__(self, md):
        ...
        for model in header.findall(util.nspath_eval("gm03:MODELS/gm03:MODEL", namespaces)):
            ...
            model_dict = {"name": name, "version": version, "uri": uri}
...
class Core(object):
    ...
    def __init__(self, md):
        ...
        if val is None:
            val = md.find(
                util.nspath_eval("gm03:GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification", namespaces)
            )
            if val is not None:
...
class MD_Metadata(_GenericObject):
    ...
    def __init__(self, md):
        ...
        self.metadata_standard_name = util.testXMLValue(
            md.find(util.nspath_eval("gm03:metadataStandardName", namespaces))
        )
        self.metadata_standard_version = util.testXMLValue(
            md.find(util.nspath_eval("gm03:metadataStandardVersion", namespaces))
        )
        ...
        if val is not None:
            values = []
            for value in val.findall(
                util.nspath_eval("gm03:GM03_2_1Core.Core.CharacterString_/gm03:value", namespaces)
            ):
                values.append(util.testXMLValue(value))
...
class EX_TemporalExtent(_GenericObject):
    ...
    def __init__(self, md):
        ...
        begin = util.testXMLValue(
            md.find(util.nspath_eval("gm03:extent/gm03:GM03_2_1Core.Core.TM_Primitive/begin", namespaces))
        )
        end = util.testXMLValue(
            md.find(util.nspath_eval("gm03:extent/gm03:GM03_2_1Core.Core.TM_Primitive/end", namespaces))
        )
...
class CI_ResponsibleParty(_GenericObject):
    ...
    def __init__(self, md):
        ...
        self.individual_first_name = util.testXMLValue(
            md.find(util.nspath_eval("gm03:individualFirstName", namespaces))
        )
        ...
        if val is not None:
            self.electronical_mail_address = util.testXMLValue(
                val.find(util.nspath_eval("gm03:GM03_2_1Core.Core.URL_/gm03:value", namespaces))
            )
...
class MD_DataIdentification(_GenericObject):
    ...
    def __init__(self, md):
        ...
        if val is not None:
            self.status = util.testXMLValue(
                val.find(util.nspath_eval("gm03:GM03_2_1Core.Core.MD_ProgressCode_/gm03:value", namespaces))
            )
        ...
        if val is not None:
            self.spatial_representation_type = util.testXMLValue(
                val.find(
                    util.nspath_eval("gm03:GM03_2_1Core.Core.MD_SpatialRepresentationTypeCode_/gm03:value", namespaces)
                )
            )

        val = md.find(util.nspath_eval("gm03:language", namespaces))
        if val is not None:
            self.language = util.testXMLValue(
                val.find(util.nspath_eval("gm03:CodeISO.LanguageCodeISO_/gm03:value", namespaces))
            )

        val = md.find(util.nspath_eval("gm03:characterSet", namespaces))
        if val is not None:
            self.character_set = util.testXMLValue(
                val.find(util.nspath_eval("gm03:GM03_2_1Core.Core.MD_CharacterSetCode_/gm03:value", namespaces))
            )

        val = md.find(util.nspath_eval("gm03:topicCategory", namespaces))
        if val is not None:
            self.topic_category = util.testXMLValue(
                val.find(util.nspath_eval("gm03:GM03_2_1Core.Core.MD_TopicCategoryCode_/gm03:value", namespaces))
            )
...
class MD_IdentificationpointOfContact(_GenericObject):
    ...
    def __init__(self, md):
        ...
        if val is not None:
            self.role = util.testXMLValue(
                val.find(util.nspath_eval("gm03:GM03_2_1Core.Core.CI_RoleCode_/gm03:value", namespaces))
            )
