...
from lantern.models.record.elements.common import Contact, ContactIdentity, Contacts, clean_dict
from lantern.models.record.elements.metadata import Metadata, MetadataStandard
